...
#include "H5Cpp.h"
using namespace H5;
const H5std_string FILE_NAME( "Randoms.h5" );
const H5std_string DATASET_NAME( "Singles" );
const int   MSPACE1_RANK = 1;   // Rank of the first dataset in memory
const int   MSPACE1_DIM = 20160;   // Dataset size in memory
//const int   MSPACE2_RANK = 1;   // Rank of the second dataset in memory
//const int   MSPACE2_DIM = 4    // Dataset size in memory
const int   FSPACE_RANK = 2;    // Dataset rank as it is stored in the file
const int   FSPACE_DIM1 = 45;    // Dimension sizes of the dataset as it is
const int   FSPACE_DIM2 = 448;   //  stored in the file
